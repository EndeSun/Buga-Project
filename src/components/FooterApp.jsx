    ...
    <footer className="bg-neutral-950 text-center text-neutral-200 w-screen">
      ...
      <section className=" grid grid-cols-3 sm:grid-cols-7 border-b-4 py-4 px-20">
        ...
        <div className="flex justify-rigth sm:col-start-7 col-start-2 ">
          ...
          {/* Instagram */}
          <Link href="/" className="mr-6 text-purple-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
          ...
          {/* Linkedin */}
          {/* <Link href="#!" className="mr-6 text-blue-400">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
      ...
      {/*Aquí me he quedado editando  */}
      <section className="mx-6 py-10 text-center">
        <div>
        </div>
        ...
        <div className="text-left">
          ...
          <p className="mb-4 flex items-center justify-center ">
            ...
            Calle San Miguel 51, 51000, Zaragoza, Spain
          </p>
      ...
      {/* Aviso legal con Cookies */}
      <section className="grid grid-cols-3">
        <div className="col-start-2">
          <Link
            className="no-underline text-xl text-neutral-200 px22  md:px-4"
            to="/AvisoLegal"
          >
            Aviso legal
          </Link>
      ...
      {/* Copyright */}
      <section className="p-6 text-center font-bold">
