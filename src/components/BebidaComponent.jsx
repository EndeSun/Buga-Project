...
function BebidaComponent({ source, nombreBebida }) {
  return (
    <>
      <div className="flex-col items-center justify-center border-4 border-slate-950 rounded-xl shadow-md shadow-teal-100 p-1 relative overflow-hidden">
        <motion.img src={source} alt={nombreBebida} whileHover={{scale: 1.3}} transition={{duration:0.3}}/>
